...
export default function UserProfilePage({ userId, onBack, onMessageUser }) {
  ...
  useEffect(() => {
    setIsFollowing(followingIds.includes(userId) || !!viewedUser?.isFollowedByMe);
  ...
  if (loading && !viewedUser) {
    return (
      <div className="prof-page">
        <AnimatedNav activeId="home" avatarUrl={authUser?.avatar} onNavigate={() => {}} />
        <div className="prof-main">
          <div style={{ textAlign: 'center', padding: '80px 0', color: '#5c6a8c' }}>Loading profile…</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="prof-page">
      <AnimatedNav activeId="home" avatarUrl={authUser?.avatar} onNavigate={(id) => { if (id === 'home') onBack?.(); }} />
  ...
  <button className="prof-cover-back-btn" onClick={onBack} title="Go back">
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="15 18 9 12 15 6"/>
        ...
        <div className="prof-identity">
          ...
          <div className="prof-info">
            ...
            <div className="prof-meta-row">
              {role && (<><span className="prof-meta-item"><BriefcaseIcon /> {role}</span><span className="prof-meta-sep">·</span></>)}
              ...
              <span className="prof-meta-item">
                <CalIcon /> {viewedUser?.joinedAt ? `Joined on ${new Date(viewedUser.joinedAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}` : ''}
              </span>
            </div>
          ...
          {!isSelf && (
            <div className="prof-actions">
              ...
              <button className="prof-edit-btn" style={{ background: '#1a2338', border: '1px solid #1e2a42', color: '#cbd5e1' }}
                onClick={() => onMessageUser ? onMessageUser(userId) : null}>
                <MsgIcon /> Message
              </button>

              <div style={{ position: 'relative' }}>
                <button className="prof-more-btn" onClick={() => setMenuOpen(o => !o)}><MoreIcon /></button>
                {menuOpen && (
                  <div className="about-dropdown">
                    ...
                    <button className="about-dropdown-item about-dropdown-item--danger">Report</button>
                  </div>
                )}
              </div>
            </div>
        ...
        {/* ── Content ── */}
        <div className={`prof-content${activeTab === 'Photos' ? ' prof-content--wide' : ''}`}>
          {activeTab === 'Feed' && (
              ...
              <div className="media-tab" style={{ flex: 1 }}>
                ...
                <div className="media-grid">
                  {viewedPhotos.length === 0 && (
                    <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '32px', color: '#5c6a8c', fontSize: 14 }}>No photos yet.</div>
                  )}
          ...
          {activeTab === 'About' && (
            <div className="about-tab">
              ...
              <div className="about-card">
                <div className="about-card-header"><span className="about-card-label">Overview</span></div>
                {viewedUser?.bio
