...
export default function CourseDetailPage({ courseId, onBack }) {
  ...
  const isComplete = chapter && progress.isChapterComplete(courseId, chapter.id);
    ...
    <div className="cr-page">
      ...
      <header className="cr-topbar">
        ...
        <div className="cr-topbar-right">
          <span className={`cdp-price-badge${course.isFree ? ' cdp-price-badge--free' : ''}`}>{priceLabel(course)}</span>
        ...
        <div className="cr-reader cdp-reader">
          <div className="cr-spread">
            ...
            <div className="cr-page-right">
              {chapter && (
                <>
                  {chapter.rightSections.map((sec, i) => (
      ...
      <footer className="cr-footer">
        <button
          className={`cr-nav-btn${isComplete ? ' cdp-complete-btn--done' : ''}`}
          onClick={() => isComplete ? progress.markChapterIncomplete(courseId, chapter.id) : progress.markChapterComplete(courseId, chapter.id)}
        >
          <CheckIcon /> {isComplete ? 'Completed' : 'Mark Chapter Complete'}
        </button>
