...
export default function LeftSidebar({ onEventsClick, onMessagesClick, onGroupsClick }) {
      ...
      <div className="nav-strip">
        {NAV_ITEMS.map(item => (
          <button
            ...
            title={item.label}
            onClick={item.create ? () => setCreateOpen(true) : item.events ? onEventsClick : item.messages ? onMessagesClick : item.groups ? onGroupsClick : undefined}
          >
            {item.icon}
          </button>
        ))}
